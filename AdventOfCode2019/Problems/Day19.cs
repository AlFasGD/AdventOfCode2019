...
namespace AdventOfCode2019.Problems
{
    ...
    {
        public override int RunPart1() => General(50, Part1Returner);
        public override int RunPart2() => General(1300, Part2Returner);
        ...
        public sealed class BeamGrid : PrintableGrid<PointType>
        {

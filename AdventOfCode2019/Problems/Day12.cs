using AdventOfCode2019.Utilities.ThreeDimensions;
using System;
...
using Vector3D = AdventOfCode2019.Utilities.ThreeDimensions.Location3D;

namespace AdventOfCode2019.Problems
{
    public class Day12 : Problem<int, long>
    {
        public override int RunPart1() => General(Part1BreakCondition, Part1PostRunner);
        public override long RunPart2() => General(Part2BreakCondition, Part2PostRunner);
        ...
        private static long LCM(long a, long b) => a / (long)BigInteger.GreatestCommonDivisor(a, b) * b;

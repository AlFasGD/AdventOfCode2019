...
namespace AdventOfCode2019.Problems
{
    ...
    {
        public override long RunPart1() => General(true, 0, Part1Returner);
        public override long RunPart2() => General(false, 1_000_000_000_000, Part2Returner);
        ...
        public class ChemicalResourceBank : KeyedObjectDictionary<Chemical, ProducantChemical>
        {
            ...
            public ChemicalResourceBank Clone() => new ChemicalResourceBank(this);
